...
export const WIKI_CATEGORIES: readonly WikiCategoryMeta[] = [
  {
    ...
    href: '/class',
    emoji: '⚔️',
    iconUrl: '/images/wiki/menu/class.webp',
    accent: 'bronze',
  ...
  },
  {
    ...
    href: '/jinryeong',
    emoji: '🔮',
    iconUrl: '/images/wiki/menu/jinryeong.webp',
    accent: 'indigo',
  ...
  },
  {
    ...
    href: '/skill',
    emoji: '✨',
    iconUrl: '/images/wiki/menu/skill.webp',
    accent: 'bronze',
  ...
  },
  {
    ...
    href: '/equipment',
    emoji: '🛡️',
    iconUrl: '/images/wiki/menu/equipment.webp',
    accent: 'jade',
  ...
  },
  {
    ...
    href: '/content',
    emoji: '🎯',
    iconUrl: '/images/wiki/menu/content.webp',
    accent: 'vermilion',
  ...
  },
  {
    ...
    href: '/munpa',
    emoji: '🏯',
    iconUrl: '/images/wiki/menu/munpa.webp',
    accent: 'jade',
