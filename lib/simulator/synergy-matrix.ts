 ...
 *
 * Sprint 22 F22-C 보강: 120 → 165 조합 확장 (165 전체 커버리지 = 100%).
 *  - 45 신규 모두 미할당 (운영자 메타 검증 대기)
 *  - score 50-58 범위 (낮은 score 으로 의도적 placeholder)
...
const SEED: readonly JinryeongSynergyDef[] = [
  ...
  // ─── Sprint 22 F22-C — 165 전체 커버리지 (45 신규 placeholder) ───
  // 모두 미할당 + B tier. 운영자 메타 검증 후 직업 추천 / score 상향 가능.
  // 기존 120 score 변경 X (9 sprint 연속 회귀 보호).
  {
    comboId: buildComboId([J.hongGildong, J.seohaeyongwang, J.sansin]),
    jinryeongIds: [J.hongGildong, J.seohaeyongwang, J.sansin],
    synergyScore: 58,
    tier: 'B',
    description: '미정 — 홍길동 + 서해용왕 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.eumyeonggwi, J.hangah]),
    jinryeongIds: [J.hongGildong, J.eumyeonggwi, J.hangah],
    synergyScore: 58,
    tier: 'B',
    description: '미정 — 홍길동 + 음명귀 + 항아 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.eumyeonggwi, J.gumiyoho]),
    jinryeongIds: [J.hongGildong, J.eumyeonggwi, J.gumiyoho],
    synergyScore: 58,
    tier: 'B',
    description: '미정 — 홍길동 + 음명귀 + 구미요호 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.eumyeonggwi, J.gunggwi]),
    jinryeongIds: [J.hongGildong, J.eumyeonggwi, J.gunggwi],
    synergyScore: 58,
    tier: 'B',
    description: '미정 — 홍길동 + 음명귀 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.myeongwang, J.sansin]),
    jinryeongIds: [J.hongGildong, J.myeongwang, J.sansin],
    synergyScore: 58,
    tier: 'B',
    description: '미정 — 홍길동 + 명왕 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.chiwoo, J.gumiyoho]),
    jinryeongIds: [J.hongGildong, J.chiwoo, J.gumiyoho],
    synergyScore: 58,
    tier: 'B',
    description: '미정 — 홍길동 + 치우 + 구미요호 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.hangah, J.gyeoktugwi]),
    jinryeongIds: [J.hongGildong, J.hangah, J.gyeoktugwi],
    synergyScore: 58,
    tier: 'B',
    description: '미정 — 홍길동 + 항아 + 격투귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.hangah, J.gumiyoho]),
    jinryeongIds: [J.hongGildong, J.hangah, J.gumiyoho],
    synergyScore: 58,
    tier: 'B',
    description: '미정 — 홍길동 + 항아 + 구미요호 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.hangah, J.gunggwi]),
    jinryeongIds: [J.hongGildong, J.hangah, J.gunggwi],
    synergyScore: 58,
    tier: 'B',
    description: '미정 — 홍길동 + 항아 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.gyeoktugwi, J.gumiyoho]),
    jinryeongIds: [J.hongGildong, J.gyeoktugwi, J.gumiyoho],
    synergyScore: 57,
    tier: 'B',
    description: '미정 — 홍길동 + 격투귀 + 구미요호 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.gyeoktugwi, J.taeyangyeosin]),
    jinryeongIds: [J.hongGildong, J.gyeoktugwi, J.taeyangyeosin],
    synergyScore: 57,
    tier: 'B',
    description: '미정 — 홍길동 + 격투귀 + 태양여신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.gyeoktugwi, J.gunggwi]),
    jinryeongIds: [J.hongGildong, J.gyeoktugwi, J.gunggwi],
    synergyScore: 57,
    tier: 'B',
    description: '미정 — 홍길동 + 격투귀 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.gumiyoho, J.taeyangyeosin]),
    jinryeongIds: [J.hongGildong, J.gumiyoho, J.taeyangyeosin],
    synergyScore: 57,
    tier: 'B',
    description: '미정 — 홍길동 + 구미요호 + 태양여신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.gumiyoho, J.gunggwi]),
    jinryeongIds: [J.hongGildong, J.gumiyoho, J.gunggwi],
    synergyScore: 57,
    tier: 'B',
    description: '미정 — 홍길동 + 구미요호 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.gumiyoho, J.sansin]),
    jinryeongIds: [J.hongGildong, J.gumiyoho, J.sansin],
    synergyScore: 57,
    tier: 'B',
    description: '미정 — 홍길동 + 구미요호 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hongGildong, J.gunggwi, J.sansin]),
    jinryeongIds: [J.hongGildong, J.gunggwi, J.sansin],
    synergyScore: 57,
    tier: 'B',
    description: '미정 — 홍길동 + 궁귀 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.eumyeonggwi, J.hangah]),
    jinryeongIds: [J.seohaeyongwang, J.eumyeonggwi, J.hangah],
    synergyScore: 57,
    tier: 'B',
    description: '미정 — 서해용왕 + 음명귀 + 항아 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.myeongwang, J.hangah]),
    jinryeongIds: [J.seohaeyongwang, J.myeongwang, J.hangah],
    synergyScore: 57,
    tier: 'B',
    description: '미정 — 서해용왕 + 명왕 + 항아 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.myeongwang, J.taeyangyeosin]),
    jinryeongIds: [J.seohaeyongwang, J.myeongwang, J.taeyangyeosin],
    synergyScore: 56,
    tier: 'B',
    description: '미정 — 서해용왕 + 명왕 + 태양여신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.hangah, J.sansin]),
    jinryeongIds: [J.seohaeyongwang, J.hangah, J.sansin],
    synergyScore: 56,
    tier: 'B',
    description: '미정 — 서해용왕 + 항아 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.gyeoktugwi, J.gumiyoho]),
    jinryeongIds: [J.seohaeyongwang, J.gyeoktugwi, J.gumiyoho],
    synergyScore: 56,
    tier: 'B',
    description: '미정 — 서해용왕 + 격투귀 + 구미요호 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.gyeoktugwi, J.gunggwi]),
    jinryeongIds: [J.seohaeyongwang, J.gyeoktugwi, J.gunggwi],
    synergyScore: 56,
    tier: 'B',
    description: '미정 — 서해용왕 + 격투귀 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.gyeoktugwi, J.sansin]),
    jinryeongIds: [J.seohaeyongwang, J.gyeoktugwi, J.sansin],
    synergyScore: 56,
    tier: 'B',
    description: '미정 — 서해용왕 + 격투귀 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.gumiyoho, J.taeyangyeosin]),
    jinryeongIds: [J.seohaeyongwang, J.gumiyoho, J.taeyangyeosin],
    synergyScore: 56,
    tier: 'B',
    description: '미정 — 서해용왕 + 구미요호 + 태양여신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.gumiyoho, J.gunggwi]),
    jinryeongIds: [J.seohaeyongwang, J.gumiyoho, J.gunggwi],
    synergyScore: 56,
    tier: 'B',
    description: '미정 — 서해용왕 + 구미요호 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.seohaeyongwang, J.taeyangyeosin, J.gunggwi]),
    jinryeongIds: [J.seohaeyongwang, J.taeyangyeosin, J.gunggwi],
    synergyScore: 56,
    tier: 'B',
    description: '미정 — 서해용왕 + 태양여신 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.eumyeonggwi, J.myeongwang, J.taeyangyeosin]),
    jinryeongIds: [J.eumyeonggwi, J.myeongwang, J.taeyangyeosin],
    synergyScore: 56,
    tier: 'B',
    description: '미정 — 음명귀 + 명왕 + 태양여신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.eumyeonggwi, J.hangah, J.gyeoktugwi]),
    jinryeongIds: [J.eumyeonggwi, J.hangah, J.gyeoktugwi],
    synergyScore: 55,
    tier: 'B',
    description: '미정 — 음명귀 + 항아 + 격투귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.eumyeonggwi, J.hangah, J.taeyangyeosin]),
    jinryeongIds: [J.eumyeonggwi, J.hangah, J.taeyangyeosin],
    synergyScore: 55,
    tier: 'B',
    description: '미정 — 음명귀 + 항아 + 태양여신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.eumyeonggwi, J.hangah, J.gunggwi]),
    jinryeongIds: [J.eumyeonggwi, J.hangah, J.gunggwi],
    synergyScore: 55,
    tier: 'B',
    description: '미정 — 음명귀 + 항아 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.eumyeonggwi, J.gyeoktugwi, J.gumiyoho]),
    jinryeongIds: [J.eumyeonggwi, J.gyeoktugwi, J.gumiyoho],
    synergyScore: 55,
    tier: 'B',
    description: '미정 — 음명귀 + 격투귀 + 구미요호 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.eumyeonggwi, J.gyeoktugwi, J.sansin]),
    jinryeongIds: [J.eumyeonggwi, J.gyeoktugwi, J.sansin],
    synergyScore: 55,
    tier: 'B',
    description: '미정 — 음명귀 + 격투귀 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.eumyeonggwi, J.gumiyoho, J.gunggwi]),
    jinryeongIds: [J.eumyeonggwi, J.gumiyoho, J.gunggwi],
    synergyScore: 55,
    tier: 'B',
    description: '미정 — 음명귀 + 구미요호 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.eumyeonggwi, J.gunggwi, J.sansin]),
    jinryeongIds: [J.eumyeonggwi, J.gunggwi, J.sansin],
    synergyScore: 55,
    tier: 'B',
    description: '미정 — 음명귀 + 궁귀 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.myeongwang, J.gyeoktugwi, J.sansin]),
    jinryeongIds: [J.myeongwang, J.gyeoktugwi, J.sansin],
    synergyScore: 55,
    tier: 'B',
    description: '미정 — 명왕 + 격투귀 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.myeongwang, J.gumiyoho, J.taeyangyeosin]),
    jinryeongIds: [J.myeongwang, J.gumiyoho, J.taeyangyeosin],
    synergyScore: 55,
    tier: 'B',
    description: '미정 — 명왕 + 구미요호 + 태양여신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.myeongwang, J.taeyangyeosin, J.sansin]),
    jinryeongIds: [J.myeongwang, J.taeyangyeosin, J.sansin],
    synergyScore: 54,
    tier: 'B',
    description: '미정 — 명왕 + 태양여신 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.myeongwang, J.gunggwi, J.sansin]),
    jinryeongIds: [J.myeongwang, J.gunggwi, J.sansin],
    synergyScore: 54,
    tier: 'B',
    description: '미정 — 명왕 + 궁귀 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.chiwoo, J.gumiyoho, J.taeyangyeosin]),
    jinryeongIds: [J.chiwoo, J.gumiyoho, J.taeyangyeosin],
    synergyScore: 54,
    tier: 'B',
    description: '미정 — 치우 + 구미요호 + 태양여신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.chiwoo, J.taeyangyeosin, J.sansin]),
    jinryeongIds: [J.chiwoo, J.taeyangyeosin, J.sansin],
    synergyScore: 54,
    tier: 'B',
    description: '미정 — 치우 + 태양여신 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hangah, J.gyeoktugwi, J.gumiyoho]),
    jinryeongIds: [J.hangah, J.gyeoktugwi, J.gumiyoho],
    synergyScore: 54,
    tier: 'B',
    description: '미정 — 항아 + 격투귀 + 구미요호 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hangah, J.gyeoktugwi, J.gunggwi]),
    jinryeongIds: [J.hangah, J.gyeoktugwi, J.gunggwi],
    synergyScore: 54,
    tier: 'B',
    description: '미정 — 항아 + 격투귀 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hangah, J.gyeoktugwi, J.sansin]),
    jinryeongIds: [J.hangah, J.gyeoktugwi, J.sansin],
    synergyScore: 54,
    tier: 'B',
    description: '미정 — 항아 + 격투귀 + 산신 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.hangah, J.taeyangyeosin, J.gunggwi]),
    jinryeongIds: [J.hangah, J.taeyangyeosin, J.gunggwi],
    synergyScore: 54,
    tier: 'B',
    description: '미정 — 항아 + 태양여신 + 궁귀 (Sprint 22 placeholder)',
  },
  {
    comboId: buildComboId([J.gyeoktugwi, J.gumiyoho, J.gunggwi]),
    jinryeongIds: [J.gyeoktugwi, J.gumiyoho, J.gunggwi],
    synergyScore: 54,
    tier: 'B',
    description: '미정 — 격투귀 + 구미요호 + 궁귀 (Sprint 22 placeholder)',
  },
